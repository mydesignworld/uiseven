<template>
  <div class="wrapper">
    <div class="container">
      <div class="login block-center loginform">
        ...
        <form @submit.prevent="login">
          ...
          <div class="d-grid gap-2">
            <button type="submit" class="btn btn-primary btn-onprimary btn-lg">Login</button>
          </div>
        </form>
        <div class="mt-3">
          <span class="text-white"> Not register? </span>
          <router-link :to="{ name: 'Register' }" class="text-white">Sigup here</router-link>
        </div>
...
import { user, google, useLogin, logout } from ".";
